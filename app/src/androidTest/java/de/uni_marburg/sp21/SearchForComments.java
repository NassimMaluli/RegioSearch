...
public class SearchForComments {
    ...
    @Test
    public void searchForComments() throws InterruptedException {
        Thread.sleep(1000);
        ...
        ViewInteraction materialCheckBox = Espresso.onView(
                allOf(withId(R.id.checkBox8), withText("Öffnungszeiten Kommentare"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction searchAutoComplete = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(ViewActions.replaceText("Harum dignissimos"), ViewActions.closeSoftKeyboard());

        ViewInteraction searchAutoComplete2 = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")), withText("Harum dignissimos"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.LinearLayout")),
