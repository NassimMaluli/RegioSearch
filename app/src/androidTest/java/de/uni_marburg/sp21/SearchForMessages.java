...
public class SearchForMessages {
    ...
    public void searchForMessages() {
        ...
        ViewInteraction materialCheckBox = Espresso.onView(
                allOf(withId(R.id.checkBox10), withText("Meldungen der Firma"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction searchAutoComplete = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(ViewActions.replaceText("Die 1."), ViewActions.closeSoftKeyboard());

        ViewInteraction searchAutoComplete2 = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")), withText("Die 1."),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.LinearLayout")),
