...
public class SearchForCompanyDescription {

    @Rule
    public ActivityTestRule<SearchActivity> mActivityTestRule = new ActivityTestRule<>(SearchActivity.class);

    @Test
    public void searchForCompanyDescription() throws InterruptedException {
        Thread.sleep(1000);
        ...
        ViewInteraction materialCheckBox = Espresso.onView(
                allOf(withId(R.id.checkBox5), withText("Beschreibung der Firma"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction searchAutoComplete = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(ViewActions.replaceText("Off with his head"), ViewActions.closeSoftKeyboard());

        ViewInteraction searchAutoComplete2 = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")), withText("Off with his head"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.LinearLayout")),
        ...
        ViewInteraction textView = Espresso.onView(
                allOf(withId(R.id.description), withText("Off with his head! "),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.ScrollView.class))),
                        isDisplayed()));
        textView.check(ViewAssertions.matches(withText("Off with his head! ")));
    }
