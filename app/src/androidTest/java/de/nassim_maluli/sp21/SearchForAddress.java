...
public class SearchForAddress {
    ...
    public void searchForAddress() throws InterruptedException {
        ...
        ViewInteraction materialCheckBox = Espresso.onView(
                allOf(withId(R.id.checkBox4), withText("Adresse der Firma"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction searchAutoComplete2 = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete2.perform(ViewActions.replaceText("Europabad"), ViewActions.closeSoftKeyboard());

        ViewInteraction searchAutoComplete3 = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")), withText("Europabad"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.LinearLayout")),
