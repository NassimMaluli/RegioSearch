...
public class SearchForCompanyType {
    ...
    public void searchForCompanyType() throws InterruptedException {
        ...
        ViewInteraction materialCheckBox = Espresso.onView(
                allOf(withId(R.id.checkBox3), withText("Arten von Unternehmen"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction searchAutoComplete = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(ViewActions.replaceText("producer"), ViewActions.closeSoftKeyboard());

        ViewInteraction searchAutoComplete2 = Espresso.onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")), withText("producer"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.LinearLayout")),
